import { femaleVector, maleVector } from "../../../lib/cloudinary_statics";
            ...
            try {
                ...
                if (req.body.documentData.cloudinaryParams) {
                    ...
                    if (expectedSignature === req.body.signature) {
                        const media = await Marts.create(req.body.documentData);
                    ...
                    /*const media = await Marts.create({
                        ...req.body.documentData,
                        cloudinaryParams:
                            req.body.documentData.sex === "male"
                                ? maleVector
                                : femaleVector,
                    });*/
                    const media = await Marts.create(req.body.documentData);
