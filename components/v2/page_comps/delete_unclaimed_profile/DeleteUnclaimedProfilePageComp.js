...
export default function DeleteUnclaimedProfilePageComp() {
    ...
    const deleteMutation = useMutation({
        mutationFn: (owner) => {
            ...
            return axios.delete(`/api/v2/delete-unclaimed/${profile.data._id}`);
        },
        onSuccess: (res) => {
            console.log("del", res);
            notify.success("Profile deleted successfully");
            router.push("/family-tree/my-trees-v2/unclaimed");
            //profile.refetch();
        ...
        <Paper p="xl" w="100%" withBorder radius="1.5em">
            <Stack align="center" p="xl" w="100%" justify="center">
                ...
                <Text c="dimmed" size="sm" align="center">
                    ...
                    <br />
                    of this profile will no longer be available
                </Text>
                <Button
                    color="red"
