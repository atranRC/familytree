...
import { useStyles } from "./WrittenStoryEditorStyles";
import { useMutation } from "react-query";
import axios from "axios";

export default function WrittenStoryEditor({
    story,
    onSaveSuccess,
    onSaveError,
    onReturn,
    ...
    const editStoryMutation = useMutation({
        mutationFn: (bod) => {
            return axios.put(
                `/api/written-stories/${story._id.toString()}`,
                form.values
            );
        },
        onSuccess: (res) => {
            ...
            <Group grow align="flex-start">
                <Stack spacing={3}>
                    ...
                    <LocationAutocompleteV2
                        ...
                        label=""
                        desc=""
                        id="written_story_editor_location"
                    />
                </Stack>
            </Group>
